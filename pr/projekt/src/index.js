...
function GameRoll(){
  ...
  redUser[0]+=a;
  square[redUser[0]]=red;
  console.log("red user:"+redUser[0]);
...
class App extends React.Component {
  ...
  render() {
    console.log(square[redUser[0]]);
  return (
    <div id="game">
    <button onClick={() => {
      document.getElementById(toString(id)).src = red;
    }}>Refresh</button>
    <table>
      <tr>
        ...
        <td className="empty"></td>
        <td className="empty"></td>
        <td className="walk" ><img src={square[id]} alt="" className="pawn" id={id}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="green"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="empty"></td>
        <td className="empty"></td>
        <td className="empty"></td>
        <td className="empty"></td>
      ...
      <tr>
        <td className="red" id={id+=1}><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="empty" id={id+=1}><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
      ...
      <tr>
        ...
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="yellow" id={id+=1}><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
      </tr>
      <tr>
        <td className="empty"></td>
        <td className="empty"></td>
      ...
      <tr>
        ...
        <td className="empty"></td>
        <td className="empty"></td>
        <td className="blue" id={id+=1}><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="walk"><img src={square[id]} alt="" className="pawn" id={id+=1}/></td>
        <td className="empty"></td>
        <td className="empty"></td>
